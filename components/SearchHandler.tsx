...
import { Megaphone, Video, Calendar, Clock, User, ArrowRight } from 'lucide-react';
...
export default function SearchHandler(props: SearchHandlerProps) {
  return (
    <Suspense fallback={
