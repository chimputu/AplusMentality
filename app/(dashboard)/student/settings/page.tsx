        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">
              Email cannot be changed here. Update it in Clerk dashboard.
            </p>
          </div>
        </div>
      </section>
          ...
          <button
            onClick={() => {
              if (confirm('Are you sure you want to delete your account? This cannot be undone.')) {
                alert('Account deletion request sent. Contact support for assistance.');
              }
            }}
            className="w-full flex items-center justify-center gap-2 bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600 px-4 py-3 rounded-lg transition"
          >
